...
public class SpecialPong extends Canvas implements KeyListener, Runnable
{
	//uncomment line below for BlinkyBall
	private BlinkyBall ball;
	//uncomment line below for SpeedUpBall
	...
	public SpecialPong()
	{
		...
		//uncomment line below for BlinkyBall
		ball = new BlinkyBall(200,200,20,20,2,2);
		
		//uncomment line below for SpeedUpBall
		//ball = new SpeedUpBall(200,200,20,20,2,2);
		...
		bottomWall = new Wall(0,600,800,10);
